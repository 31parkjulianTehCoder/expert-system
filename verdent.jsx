function Main(){
  ...
  return (
    <div style = {{ margin: 0, padding: 0, boxSizing: "border-box", fontFamily: "sans-serif",}}>
        ...
        {/*<div style={{display: "flex", justifyContnet: "center", alignItems: "center"}}>*/}
        {/*    <div style={{*/}
        {/*        width: "50vw",*/}
        {/*        height: "50vw",*/}
        {/*        display: "grid",*/}
        {/*        gridTemplateColumns: `repeat(${width * 2 + 1}, 1fr)`,*/}
        {/*        gridTemplateRows: `repeat($height}, 1fr)`,*/}
        {/*    }}> {toRender} </div>*/}
        {/*</div>*/}

        {/*<div style={{transform: "rotate(30deg)"}}>*/}
        {/*    <div style={{width: 100, height: 86.6, backgroundColor: "dodgerblue", border: "2px solid gray", transform: "skew(-31.5deg)"}}>hi</div>*/}
        {/*    <div style={{width: 100, height: 86.6, backgroundColor: "dodgerblue", border: "2px solid gray", transform: "skew(-31.5deg)"}}>hi</div>*/}
        {/*    <div style={{width: 100, height: 86.6, backgroundColor: "dodgerblue", border: "2px solid gray", transform: "skew(-31.5deg)"}}>hi</div>*/}
        {/*    <div style={{width: 100, height: 86.6, backgroundColor: "dodgerblue", border: "2px solid gray", transform: "skew(-31.5deg)"}}>hi</div>*/}
        {/*</div>*/}
